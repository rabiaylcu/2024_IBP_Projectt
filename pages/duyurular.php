...
if(isset($_POST['submit'])){
   $description = mysqli_real_escape_string($conn, $_POST['desc']);
         ...
         $insert = "INSERT INTO news(description, date) VALUES('$description', CURDATE())";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand-link">
      <img src="../img/messagel.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
      <span class="brand-text font-weight-light">Mesajlar</span>
  </div>
 ...
 <form action="" method="post">
      ...
      <input type="text" name="desc" required placeholder="Duyuru">
  ...
  <?php $result = mysqli_query($conn, "SELECT * FROM news");
